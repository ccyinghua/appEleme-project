    ...
    <div class="ratings-content">
      ...
      <div class="overview">
        <div class="overview-left">
          ...
          <div class="rank">高于周边商家{{seller.serviceScore}}</div>
        </div>
...
export default {
  ...
  methods: {
    needShow(type, text) {  // 筛选显示的列表
      if (this.onlyContent && !text) {   // 选择了只显示有内容的评价同时本条评论没有内容，false不显示
        return false
      }
      if (this.selectType === ALL) {  // 状态是显示ALL全部，true显示
        return true
      } else {
